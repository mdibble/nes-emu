...
impl CPU {
    ...
    pub fn execute(&mut self, opcode: u8) {
        match opcode {
            ...
            0x28 => self.plp(Mode::NoMode),
            0x29 => self.and(Mode::IMM),
            0x2A => self.rol(Mode::NoMode),
            ...
            0x88 => self.dey(Mode::NoMode),
            0x8A => self.txa(Mode::NoMode),
            ...
            0x98 => self.tya(Mode::NoMode),
            0x99 => self.sta(Mode::ABY),
            0x9A => self.txs(Mode::NoMode),
            ...
            0xA8 => self.tay(Mode::NoMode),
            0xA9 => self.lda(Mode::ABY),
            0xAA => self.tax(Mode::NoMode),
            ...
            0xB8 => self.clv(Mode::NoMode),
            0xB9 => self.lda(Mode::ABY),
            0xBA => self.tsx(Mode::NoMode),
            ...
            0xC8 => self.iny(Mode::NoMode),
            0xC9 => self.cmp(Mode::IMM),
            0xCA => self.dex(Mode::NoMode),
            ...
            0xE8 => self.inx(Mode::NoMode),
            0xE9 => self.sbc(Mode::IMM),
            0xEA => self.nop(Mode::NoMode),
